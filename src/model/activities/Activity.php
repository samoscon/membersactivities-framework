 ...
 * @author Dirk Van Meirvenne <van.meirvenne.dirk at gmail.com>
 */
abstract class Activity extends \controllerframework\db\DomainObject {
    /**
    ...
    public static function getInstance(array $row): Activity {
        ...
        if($children) {
           return ActivityComposite::getInstance($row);
        }
    ...
    public function getParticipants(): \controllerframework\db\ObjectMap {
        if ($this->parent) {
            ...
            $results = new \controllerframework\db\ObjectMap();
        }
